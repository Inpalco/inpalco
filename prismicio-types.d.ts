...
type ContactDocumentDataSlicesSlice = FaqSlice | FooterSlice | ContactSlice;
...
export interface ContactSliceDefaultPrimary {
  ...
  /**
   * Whatsapp field in *Contact → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: Whatsapp
   * - **API ID Path**: contact.default.primary.whatsapp
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
