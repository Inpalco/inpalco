        ...
        <main id="topo" className="flex flex-col w-full px-5 md:px-0">
                ...
                <div className="flex flex-col items-center w-full max-w-7xl gap-10 px-4 md:gap-20">
                    <div className="flex flex-col w-full gap-2">
                        <div className="relative">
                            <Link className="text-white text-2xl font-medium md:text-lg w-full mb-4 transition hover:text-orange-500 md:w-max hover:scale-105 absolute top-10 left-6 md:top-16 md:left-16" href={"/blog"}>Voltar</Link>
                            <BlogImg data={post.data} />
                            <h1 className="text-white text-2xl md:text-4xl absolute bottom-10 left-6 md:bottom-16 md:left-16">{post.data.title}</h1>
                        </div>
            ...
            <div className="flex w-full items-center justify-center py-14 md:py-20">
                <div className="flex flex-col items-center w-full max-w-7xl gap-4 px-4 md:gap-10">
                    ...
                    <div className="w-full grid grid-cols-1 gap-12 md:gap-6 items-stretch justify-items-center md:grid-cols-3">
                        {posts.slice(0, 3).map(post => (
                            <div key={post.id} className="flex flex-col gap-4 w-full">
                                <Image 
                                    ...
                                    width={960} 
                                    height={480} 
                                    className="object-cover w-full md:h-[16rem] rounded-3xl max-h-60 md:max-h-80" />
