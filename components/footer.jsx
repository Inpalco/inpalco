            ...
            <div className="flex flex-col items-center justify-between w-full max-w-7xl gap-10 px-4 md:gap-20 md:flex-row">
                <div className="flex flex-col gap-4 flex-1">
                    <div className="flex items-center gap-2">
                        { data.facebook && (
                        <Link target="_blank" href={data.facebook} className="p-2 rounded-full hover:bg-orange-200 transition">
                            <FacebookLogo size={32} className="text-orange-500" />
                        </Link> ) 
                        }
                        { data.instagram && (
                        <Link target="_blank" href={data.instagram} className="p-2 rounded-full hover:bg-orange-200 transition">
