...
export default function TitleSection({data}) {
    return (
        <div className="flex w-full items-center justify-center py-20 bg-purple-100">
            ...
            <Link className="text-purple-500 font-medium text-lg text-left w-full mb-4 transition hover:text-orange-500 md:w-max hover:scale-105" href={data.previouspage}>Voltar</Link>
