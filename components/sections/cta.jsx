...
export default function Cta({data}) {
  return(
    <Section className="flex-col md:flex-row gap-0 md:gap-20" mainClassName="bg-purple-100 rounded-2xl">
      {/* TITLE */}
      <div className="flex flex-col w-full min-w-80 flex-1 gap-4 py-24">
